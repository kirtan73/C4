<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Version5.aspx.cs" Inherits="WebApplication1.Kirtan_CE60.Version5" %>
        ...
        <asp:Table ID="Table1" runat="server">
            <asp:TableRow>
                <asp:TableCell>
                    ...
                    <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="true"  OnCheckedChanged="CheckBox1_CheckedChanged" Text="Add Picture"/>
                    <br /><br />
                ...
                <asp:TableCell >
                    <asp:Panel ID="Panel1" runat="server" Width="500px" Height="600px" HorizontalAlign="Center">
                        ...
                        <asp:Image ID="im1" ImageUrl="img.jpg" runat="server" Visible="false" Height="200px" Width="200px"  />
                    </asp:Panel>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
